  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ekiliApp.parameter.home.createOrEditLabel">
            <Translate contentKey="ekiliApp.parameter.home.createOrEditLabel">Create or edit a Parameter</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : parameterEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label for="parameter-paraent">
                  <Translate contentKey="ekiliApp.parameter.paraent">Paraent</Translate>
                </Label>
